...
- 각 웹 포털에 파비콘(`favicon.svg`, 원본 앱 아이콘 벡터 기반) + `HttpServerService` 라우트 (`ContentType.Image.SVG`, `/favicon.svg`) — 서비스별 색상 구분: 맥줍줍=블루(#0D47A1→#0066FF), 요금줍줍=차콜 슬레이트(#22303F→#121A24)
