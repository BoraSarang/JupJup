...
- `pj_web/index.html`: `modalResponse pre`→`div.md-body`, `pmContent pre`→`textarea+저장`.
- `pj_web/style.css`: `.md-body`, `.pm-last-response`, 벌크 버튼 스타일.

## 3. 검증

- `./build_and_run.sh build android` + `:services:promptjournal:testDebugUnitTest`
